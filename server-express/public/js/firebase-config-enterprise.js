...
import { initializeAppCheck, ReCaptchaEnterpriseProvider } from "https://www.gstatic.com/firebasejs/10.13.0/firebase-app-check.js";
...
// Initialize Firebase App Check (reCAPTCHA Enterprise) if site key is present
try {
  ...
  if (siteKey && typeof initializeAppCheck === 'function' && isProdHost) {
    ...
    console.debug('✅ App Check inicializado (reCAPTCHA Enterprise)');
  } else {
